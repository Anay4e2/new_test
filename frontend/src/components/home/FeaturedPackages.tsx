...
export const FeaturedPackages: FC<Props> = ({ packages }) => {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-white dark:bg-slate-900 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        {/* Section Header */}
        <div className="text-center mb-8 sm:mb-14">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-3">Curated Travel Packages</h2>
