        ...
        >
            ...
            {isEditMode && (
                <button
                    {...attributes}
                    {...listeners}
                    className="absolute -left-10 top-0 p-1 rounded-md bg-primary/10 hover:bg-primary/20 text-primary cursor-grab active:cursor-grabbing transition-colors opacity-0 group-hover/day:opacity-100"
